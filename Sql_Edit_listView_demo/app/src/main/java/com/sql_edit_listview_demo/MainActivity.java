package com.sql_edit_listview_demo;
...
import com.sql_edit_listview_demo.db.NotesDB;
...
public class MainActivity extends ListActivity {
	...
	private OnClickListener btnAddNote_clickHandler = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			startActivityForResult(new Intent(MainActivity.this,
					AtyEditNoteActivity.class), REQUEST_CODE_ADD_NOTE);
		}
	};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		// 显式Intent开启编辑笔记页面
		Intent i = new Intent(MainActivity.this, AtyEditNoteActivity.class);

		// 传入笔记id，name，content
		i.putExtra(AtyEditNoteActivity.EXTRA_NOTE_ID,
				c.getInt(c.getColumnIndex(NotesDB.COLUMN_NAME_ID)));
		i.putExtra(AtyEditNoteActivity.EXTRA_NOTE_NAME,
				c.getString(c.getColumnIndex(NotesDB.COLUMN_NAME_NOTE_NAME)));
		i.putExtra(AtyEditNoteActivity.EXTRA_NOTE_CONTENT,
